...
export default function HomePage() {
  return (
    <main>
      {/*
        Hero is deliberately not animated. It is the LCP element, and starting
        it at opacity 0 would hold the largest paint behind hydration.
      */}
      <section className={`${shell} pt-16 pb-20 text-center md:pt-24 md:pb-28`}>
        ...
        <ImagePlaceholder
          className="mt-16 aspect-[16/10] w-full md:mt-20 md:aspect-[16/7]"
          label="Hero photography to follow"
        />
      </section>
      ...
      <section className="border-t border-line py-20 md:py-28">
        <div className={shell}>
          ...
          <Stagger
            as="ol"
            className="mt-14 grid gap-12 md:grid-cols-4 md:gap-8"
          >
            {steps.map((step) => (
        ...
        <div className={shell}>
          <Reveal>
            ...
            <p className="mt-4 max-w-[60ch] text-[1.0625rem] leading-[1.6] text-ink-muted">
              ...
              happens if you change your mind — answered plainly, before you
              spend anything.
            </p>
            <Link
              href="/faq"
